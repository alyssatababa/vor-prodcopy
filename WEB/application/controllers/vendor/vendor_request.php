...
class vendor_request extends CI_Controller {
	...
	public function get_all_data(){
		$data['result_data'] = $this->rest_app->get('index.php/vendor/vendor_request/view_all_data', '', '');
		echo json_encode($data['result_data']);
	}

	public function get_smvs(){
		$data['result_data'] = $this->rest_app->post('index.php/vendor/vendor_request/view_vendor_request', $data, '');
		echo json_encode($data['result_data']);
	}
