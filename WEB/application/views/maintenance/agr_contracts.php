...
<div class="container mycontainer">
	<div class="row">
		<div class="col-md-10"><h4>Contracts and Agreements (C/A)</h4></div>
		<div class="col-md-2"><button type="button" class="btn btn-primary" name="" data-toggle="modal" data-target="#addNewModal">Add New</button>
		</div>
	</div>
<div class = "row">				
	<div class="panel panel-default">
<div class="panel-body">
	<h4>Contract / Agreement Search</h4>
