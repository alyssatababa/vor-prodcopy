...
<html lang="en">
  ...
  <body class="login" onload="check_reset_valid(<?=$reset?>)">
    ...
    <div class="container">
     ...
     <form class="form-signin" action="<?=base_url();?>index.php/setpassword/validate_password/<?php echo isset($token) ?  $token: ''; ?>" method="POST">
				...
				<h5 class="form-signin-heading">Set Password</h5>
					...
					<div class="panel-body">
                        <!--
                            ...
                            // ' OR '1' = '1
                        -->
                        <label>Your login ID is <h4><?=isset($username) ?  $username: '';?></h4></label>
						<br>
                        <label id="label_new_password">Enter your password</label>
						<br />
