	...
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			<div class="modal-header">
				<span class="reject_shortlist">
					<h3 class="modal-title">Reject Reason</h3>
				</span>
			</div>
			<div class="modal-body">
                <div class="container-fluid" id="view_modal">
					<textarea name="reject_reason" id="reject_reason" class="form-control editable no-specialchar_note field-required"></textarea>
				</div>
			</div>
			<div class="modal-footer">
                <span class="reject_shortlist">
					<input type="button" id="reject_btn" onclick="approve_creation(0)" value="Ok" class="btn btn-primary">
					<input type="button" id="cancel_btn" class="btn btn-default" value="Cancel" data-dismiss="modal">
				</span>
			</div>
		</div>
	</div>
...
<div class="container mycontainer" id="mycontainer">
	...
	<div class="row">
		<div class="col-md-4">
			<h4>RFQ/RFB Creation - Approval</h4>
			<a href="#" id="approval_history">Approval History</a>
		</div>
...
<div class="panel-body">
	...
	<input type="hidden" id="createdbyid" name="createdbyid" value="<?=$createdbyid?>">
						...
						<span class="rfq_approval_history" style="display:none;">
							<div class="panel panel-primary">
								...
								<table id="tbl_history" class="table table-bordered">
									...
									<tbody id="tbl_approval_body">
										<script id="approval_template" type="text/template">
											{{#table_history}}
												<tr>
...
<script>
	...
	var approval_template = $('#approval_template').html();
	$('#approval_history').on('click', function() {
	    ...
	    var ajax_type = 'POST';
	    var url = BASE_URL + "rfqb/approval/rfq_approval_table/" + document.getElementById('rfx_id').value + "/";
	    ...
	    var success_function = function(responseText)
	    {
	        ...
	        $('#tbl_approval_body').html(Mustache.render(approval_template, DATA));
