...
<div class="container mycontainer">
	...
	<div class="panel panel-default">
		...
		<input type="hidden" id="trade_vendor_type" name="trade_vendor_type" value="<?php echo isset($trade_vendor_type)?$trade_vendor_type:'0'; ?>">
		...
		<div class="row">
			<div class="col-sm-12">
                ...
                <div class="row" id="div_row_vendor_id_pass">
                    <br>
                        <div class="col-sm-12">
                                <!-- <div class="col-sm-6"> -->
                    		<div class="form-group">
                                <!-- <label for="mobile_no" class="col-sm-2 control-label">Vendor ID/Pass</label> -->
                                <div class="col-sm-12" id="div_mobno">
                                        <input type="hidden" id="mobno_count" name="mobno_count" value="1">
                                        <!-- <div class="input-group"> -->
                                        <div class="form-inline cls_div_mobnoinline" id="div_mobnoinline1" name="div_mobnoinline1">
                                            <a class="cls_mobno" href="#" id="vi_vendor_id_pass_vendor_review" name="vvidpsv1" style="margin-left: 40px;">* Request for Vendor ID/Pass </a>

                                            <p style="margin-left: 40px;" id="watsons_vendor_id_pass_review">* Request for Vendor ID/Pass</p>
                                        </div>
                                        <!-- </div> -->
                                </div>
                            </div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="container-fluid">
								...
								<span class="vi_vendor_id_pass_vendor_review" style="display:none;">
                                        ...
                                        <table class="table table-bordered" id="tbl_vendorid" afflop="1">
                                                ...
                                                <script id="vendor_id_request_history_template_vendor" type="text/template">
                                                                <tr id="tr_vendorid0" class="cls_tr_vendorid" hidden>
                                                                        ...
                                                                        <td><input type="text" id="vendorid_lname0" name="vendorid_lname0" style="text-transform:uppercase" class="form-control input-sm cls_vendorid field-required limit-cha        rs" data-label="vendorid_lastname"  maxlength="100""></td>
                                                                        ...
                                                                        <option value={{{REQUEST_TYPE_NAME}}}>{{{REQUEST_TYPE_NAME}}}</option>e}}
                                                                        </select>
                                                                        </td>
        ...
        var success_function = function(responseText)
        {
            ...
            if (responseText != 0)
            {
            	...
            	for(i=0; i < data.count_cat; i++){
            		if(data.rs_cat.includes(259)){
            			if($('#vendor_invite_type2').val() != 'Update Vendor Information'){
            				//console.log('1');
            				$("#is_watsons").val('1');
	            			$("#vi_vendor_id_pass_vendor_review").hide();
	            			$("#watsons_vendor_id_pass_review").show();
            			}else{
            				//console.log('2');
            				$("#vi_vendor_id_pass_vendor_review").show();
            				$("#watsons_vendor_id_pass_review").hide();
            			}
            		}else{
            			//console.log('3');
            			$("#vi_vendor_id_pass_vendor_review").show();
            	...
            	if (data.count_vreg > 0)
            	{
					...
					//console.log("VTT= " + vt);
					//console.log(data.rs_vreg[0].OWNERSHIP_TYPE, data.rs_vreg[0].TRADE_VENDOR_TYPE,cat_sup, vt);
					...
					for (var i = 0, j = 1; i < data.count_cat_avc; i++, j++){ // i is for object, j is for element
						if(data.count_vreg > 0){
							if((data.rs_registration_type == 4 && (data.rs_vreg[0].VENDOR_CODE_02 != '' && data.rs_vreg[0].VENDOR_CODE_02 != null)) || data.rs_vreg[0].PREV_REGISTRATION_TYPE == 4){
								...
								var new_row = avc_cat_template.attr({'id':'tr_avc_catsup'+j,'class':'cls_tr_cat'});
								new_row.find(':input').attr({'id':'acategory_id'+j, 'name':'category_id'+j, 'value': data.rs_cat_avc[i].CATEGORY_ID});
								new_row.find('span#avc_category_name'+i).attr('id','avc_category_name'+j);
								new_row.find('span#avc_sub_category_name'+i).attr('id','avc_sub_category_name'+j);
			...
			$(document).ready(function(){
				...
				$('#cat_sup input[type=hidden]').each(function(){
					...
					//if( (data.rs_registration_type == 4 && (data.rs_vreg[0].STATUS_ID != 12 && data.rs_vreg[0].STATUS_ID != 198)) || data.rs_registration_type != 4){
				...
				// cetegories END
				get_list_docs(ownership, trade_vendor_type,z_cat_sup, vendor_type, data.rs_registration_type).done(function(){
