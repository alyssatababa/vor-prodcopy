...
function create_vendor_table(data,table_name){
   ...
   //console.log(data);
    ...
    if(_positionid == 10){
        ...
        let _status = [3,11,12,18,19,194,195,192];
        ...
        //const cur_date = new Date('2024-02-14');
        const cur_date = new Date(_val.LATEST_DATE_UPDATED);
        const tom_date = new Date(_val.TOM_DATE);

       // console.log(_val.LATEST_DATE_UPDATED);
        

       /* if(_val.DATE_DIFF <= 0){
        	console.log('here1');
        	console.log(_val.DATE_DIFF);
        	console.log(_val.CUR_DATE);
        }else if(_val.DATE_DIFF > 0){
			console.log('here2');
			console.log(_val.DATE_DIFF);
			console.log(_val.CUR_DATE);
        }else{
...
*/
        // date difference for same day update registration  _val.DATE_DIFF
        if(_statusid == 190 && _statusresult == false &&  _uploadcomplete != 1 && _val.DATE_DIFF <= 0){
            _gtd += '<td>Submit Additional Requirements</td>';
        }else if(_statusid > 9 && _statusresult == false &&  _uploadcomplete != 1){
            if(hour >= 9){
        ...
        }else if(_statusid == 19 && _statusresult == true &&  _uploadcomplete == 1 && _val.DATE_DIFF <= 0){
            _gtd += '<td>Update Registration</td>';
        }else if(_statusid == 19 && _statusresult == true &&  _uploadcomplete == 1 && _val.DATE_DIFF >= 1){
            if(_val.DATE_DIFF == 1){
                if(hour >= 9){
                    _gtd += '<td><a href = "#" data-action-path="vendor/registration/index/'+_vendorinviteid+'" data-crumb-text="Update Registration" data-invite-id ="'+_vendorinviteid+'" class = "cls_action">Update Registration</a></td>';
                }else{
                    _gtd += '<td>Update Registration</td>';
                }
            }else{
        ...
        }else if(_statusid == 19 && _statusresult == true &&  _uploadcomplete == 0 && _val.DATE_DIFF <= 0){
           _gtd += '<td>Update Registration</td>';
        }else if(_statusid == 19 && _statusresult == true &&  _uploadcomplete == 0 && _val.DATE_DIFF >= 1){
           _gtd += '<td><a href = "#" data-action-path="vendor/registration/index/'+_vendorinviteid+'" data-crumb-text="Update Registration" data-invite-id ="'+_vendorinviteid+'" class = "cls_action">Update Registration</a></td>';
        }else if(_statusid == 3 && _statusresult == true &&  _uploadcomplete == 1 ){
            _gtd += '<td><a href = "#" data-action-path="vendor/registration/index/'+_vendorinviteid+'" data-crumb-text="Update Registration" data-invite-id ="'+_vendorinviteid+'" class = "cls_action">Update Registration</a></td>';
        }else{
