					...
					<div class="row">
						...
						<div class="col-md-8">
							<div class="pull-right">
								<input type="button" class="btn btn-default" id="approval_registrations" value="Approve" style="width: 130px;">
							</div>
						</div>
					</div>
				</div>
					...
					<table id="main_table" class="table table-hover" style="width: 100%;">
						<thead>
							<tr>
								...
								<th data-col="ACTIVATE">Approve</th>
							</tr>
						</thead>
						<tbody id="tbl_body">
...
<script type="text/javascript">
	...
	{
		var ajax_type = 'POST';
        var url = BASE_URL + "maintenance/registration_activation/approval_table";
