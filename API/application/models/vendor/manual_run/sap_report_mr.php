...
class Sap_report extends CI_Model
{
	...
	function get_data(){
		...
		//$date_to = $this->db->query("SELECT * FROM SMNTP_VENDOR_STATUS_LOGS WHERE status_id = 19 AND DATE_UPDATED BETWEEN DATE_SUB(".$date.", INTERVAL ".$sys." DAY) AND ".$date." AND VENDOR_INVITE_ID IN(22590, 21880)");
